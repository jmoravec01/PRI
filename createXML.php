        ...
        <div class="center" style="overflow: auto; height: 100%; margin-top: 25px; margin-bottom: 25px">
            <form method="POST" action="" style="width: 80%; background-color: #333333aa; border-radius:50px;">
                ...
                <div style="color: white">
                    ...
                    <input type="text" name="nazev_souboru" id="nazev_souboru" required placeholder="název"><br><br>

                    <label for="dekan">Děkan PŘF</label>
                    <input type="text" id="dekan" name="dekan" required placeholder="Michal Varady"><br><br>
                </div>
                ...
                <div class="create">
                    <div class="create-column">
                        ...
                        <input type="text" id="zkratka_katedry" name="zkratka_katedry" required placeholder="KI"><br><br>

                        <label for="webove_stranky">web</label>
                        <input type="text" id="webove_stranky" name="webove_stranky" required placeholder="ki.ujep.cz"><br><br>
                    </div>

                    <div class="create-column">
                        <h3>VEDOUCÍ</h3>
                        <label for="vedouci_jmeno">jméno</label>
                        <input type="text" id="vedouci_jmeno" name="vedouci_jmeno" required placeholder="Jiří Škvor"><br><br>

                        <label for="vedouci_telefon">telefon</label>
                        <input type="tel" pattern="\+[0-9]{12}" id="vedouci_telefon" name="vedouci_telefon" required placeholder="+420"><br><br>
                    </div>
