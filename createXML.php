...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $vedouci_email = $_POST['vedouci_email'];
        ...
        if (!empty($vedouci_email)) {
            $vedouci->addChild('email', $vedouci_email); //tady divný
        }
        // zaměstnanci
    ...
    <main>
        ...
        <div class="center">
            <form method="POST" action="" style="background-color: white; border-radius:50px;">
                ...
                <label for="zkratka_katedry">Zkratka katedry</label>
                <input type="text" id="zkratka_katedry" name="zkratka_katedry" required><br><br>

                <label for="webove_stranky">Webové stránky</label>
                <input type="text" id="webove_stranky" name="webove_stranky"><br><br>

                <label for="vedouci_jmeno">Jméno vedoucího</label>
                <input type="text" id="vedouci_jmeno" name="vedouci_jmeno"><br><br>

                <label for="vedouci_telefon">Telefon vedoucího</label>
                <input type="text" id="vedouci_telefon" name="vedouci_telefon"><br><br>

                <label for="vedouci_email">Email vedoucího</label>
                <input type="email" id="vedouci_email" name="vedouci_email"><br><br>

                <label for="zamestnanec_jmeno">Jméno zaměstnance</label>
                <input type="text" id="zamestnanec_jmeno" name="zamestnanec_jmeno" required><br><br>

                <label for="zamestnanec_telefon">Telefon zaměstnance</label>
                <input type="text" id="zamestnanec_telefon" name="zamestnanec_telefon" required><br><br>

                <label for="zamestnanec_email">Email zaměstnance</label>
                ...
                <select id="zamestnanec_pozice" name="zamestnanec_pozice">
                    ...
                    <option value="assistant">Odborný asistent</option>
                </select><br><br>

                <label for="predmet_zkratka">Zkratka předmětu</label>
                <input type="text" id="predmet_zkratka" name="predmet_zkratka" required><br><br>

                <label for="predmet_nazev">Název předmětu</label>
                <input type="text" id="predmet_nazev" name="predmet_nazev" required><br><br>

                <label for="predmet_popis">Popis předmětu</label>
